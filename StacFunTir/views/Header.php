...
<nav class="navbar fixed-top navbar-expand-md col-12 navbar-dark bg-dark p-2 text-md-center shadow-sm">
    ...
    <div class="collapse navbar-collapse" id="navbarMenu">
        <ul class="navbar-nav">
            ...
            <li class="nav-item m-2">
                <a class="nav-link beginButton" href="\..\controllers\gameControllers\LauncherController.php" id="gameLauncher" role="button" class="btn" name="startBtn">Démarrer</a>
            </li>
            <?php } ?>
